    ...
    <Router>
      <div className=" mt-16 w-full max-w-[32rem] flex flex-col gap-4">
        <Button fullWidth size="lg" variant="outlined">
          <Link className="block w-full" to="/summarizer/url">URL</Link>
        </Button>
        <Button fullWidth size="lg" variant="outlined">
          <Link className="block w-full" to="/summarizer/text">Text</Link>
        </Button>
        <Button fullWidth size="lg" variant="outlined">
          <Link className="block w-full" to="/summarizer/image">Image</Link>
        </Button>
      </div>
